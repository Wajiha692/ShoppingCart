...
public class cart
{
	...
	public static String[] products = {null,    "1.) Quarter-Pounder Burger  = 50.00Rs",
	 											"2.) One-Percenter (2-Stacks of Quarter Pounder Patty) = 99.00Rs",
	 											"3.) Tombstone Piledriver (3 Stacks of Quarter Pounder Patty) = 150.00Rs",
	 											"4.) God's Last Gift (Tombstone Burger with 100g of Carolina Reaper) = 200.00Rs"};
